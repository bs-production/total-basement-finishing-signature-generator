      ...
      <div class="hero-body">
        <div class="container">
          <div class="th-logo has-text-centered">
            <img src="https://dc69b531ebf7a086ce97-290115cc0d6de62a29c33db202ae565c.ssl.cf1.rackcdn.com/321/DES-We-Fix-Logo.png" alt="" style="width:280px">
          </div>
 ...
 <!----------------- Modal ---------------->    
        ...
        <modal name="output" :height="500">
          ...
          <div class="gif-box level-item has-text-centered">
            <ul>
              <li>1. Place cursor at the top-left corner of compnay logo and click & drag to bottom-right corner of the disclaimer</li>
